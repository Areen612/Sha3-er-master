...
class CompanyProfilePage extends StatefulWidget {
  ...
  CompanyProfilePage({this.companyAuth});

  ModelCompanyAuth? companyAuth;
...
class _CompanyProfileUserState extends State<CompanyProfilePage> {
          ...
          body: Padding(
            ...
            child: ListView(
              ...
              children: [
                ...
                NameWidgetCompany(company: widget.companyAuth),
                const SizedBox(height: 24),
                const Divider(),
