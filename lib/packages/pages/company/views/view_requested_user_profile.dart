...
class RequestedUserProfile extends StatefulWidget {
  static const id = 'RequestedUserProfile';
  const RequestedUserProfile({
    required this.modelUserAuth,
    Key? key,
  }) : super(key: key);
  final ModelUserAuth modelUserAuth;

  @override
  _UserProfileState createState() => _UserProfileState();
}

class _UserProfileState extends State<RequestedUserProfile> {
        ...
        builder: (context) => Scaffold(
          ...
          body: ListView(
            ...
            children: [
              ...
              NameWidgetUser(
                name: widget.modelUserAuth.firstName!,
                specialty: widget.modelUserAuth.specialty!,
              ),
              const SizedBox(height: 24),
              const Divider(),
              const SizedBox(height: 24),
              ...
              Padding(
                ...
                child: DetailsWidget(
                  ...
                  description: widget.modelUserAuth.experience,
                ),
              ),
              const SizedBox(height: 48),
              Padding(
                ...
                child: DetailsWidget(
                  ...
                  description: widget.modelUserAuth.skills,
                ),
              ),
